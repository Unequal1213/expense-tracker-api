...
Create a portfolio-ready backend project that demonstrates Python backend development, relational database modeling, CRUD operations, filtering, sorting, and financial summary/statistics logic.

The application will help track personal income, expenses, categories, transaction dates, and financial summaries.

## Repository

GitHub repository:
https://github.com/Unequal1213/expense-tracker-api
